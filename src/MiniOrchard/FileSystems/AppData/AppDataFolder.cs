...
using MiniOrchard.Validation;
//using MiniOrchard.FileSystems.VirtualPath;

namespace MiniOrchard.FileSystems.AppData
{
	public class AppDataFolder : IAppDataFolder
	{
		...
		private void MakeDestinationFileNameAvailable(string destinationFileName)
		{
			...
			{
				throw new FrameworkCoreException(string.Format("Unable to make room for file \"{0}\" in \"App_Data\" folder", destinationFileName), e);
			}
		}
