...
namespace MiniOrchard.Utility.Extensions {
    public static class HttpRequestExtensions {
        ...
        /// </summary>
        /// <example>http://localhost:3030/MiniOrchardLocal</example>
        /// <remarks>Prevents port number issues by using the client requested host</remarks>
        ...
        /// </summary>
        /// <example>http://localhost:3030/MiniOrchardLocal/Admin/Blogs</example>
        /// <remarks>Prevents port number issues by using the client requested host</remarks>
