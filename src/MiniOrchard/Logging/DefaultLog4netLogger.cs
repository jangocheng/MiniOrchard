namespace MiniOrchard.Logging
{
	...
	public class DefaultLog4netLogger : MarshalByRefObject, Logger
	{
		private static readonly Type declaringType = typeof(DefaultLog4netLogger);
		...
		internal DefaultLog4netLogger()
		{
		}

		internal DefaultLog4netLogger(ILog log, DefaultLog4netFactory factory)
		...
		protected internal DefaultLog4netFactory Factory { get; set; }
